...
# onnx_model = "C:/Users/Dinesh Kumar M/OneDrive/Desktop/college/bhavani/super/s2v2x2_spatrad.onnx"
...
# ONNX model path (relative, works locally and on Render)
MODEL_PATH = os.path.join(BASE_DIR, "s2v2x2_spatrad.onnx")
...
def run_super_resolution(mosaic_tif, output_tif):
    ...
    profile.update(
        ...
        transform=rasterio.Affine(
            profile["transform"].a / factor, 0, profile["transform"].c,
            0, profile["transform"].e / factor, profile["transform"].f
        )
    )
